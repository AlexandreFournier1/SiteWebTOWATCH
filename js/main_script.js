            ...
            <li style="list-style: none;" style="background-color: #00DD00">
                <div class="dropdown" style="background-color: #00DD00">
                    ...
                    <ul id="${item.id}-dropdown" class="dropdown-menu hidden">
                        <li style="list-style: none;" style="background-color: #00DD00"><a href="${item.lien_info}" target="_blank" style="background-color: #00DD00">INFORMATIONS</a></li>
                        <li style="list-style: none;" style="background-color: #00DD00"><a href="${item.lien_trailer}" target="_blank" style="background-color: #00DD00">TRAILER</a></li>
                        <li style="list-style: none;" style="background-color: #00DD00"><a href="${item.lien_vo}" target="_blank" style="background-color: #00DD00">FULL ANGLAIS</a></li>
                        <li style="list-style: none;" style="background-color: #00DD00"><a href="${item.lien_vf}" target="_blank" style="background-color: #00DD00">FULL FRANCAIS</a></li>
                    </ul>
                </div>
            </li>
        `).join("");
            ...
            <li style="list-style: none;" style="background-color: #00DD00">
                <div class="dropdown" style="background-color: #00DD00">
                    ...
                    <ul id="${film.id}-dropdown" class="dropdown-menu hidden">
                        <li style="list-style: none;" style="background-color: #00DD00"><a href="${film.lien_info}" target="_blank" style="background-color: #00DD00">INFORMATIONS</a></li>
                        <li style="list-style: none;" style="background-color: #00DD00"><a href="${film.lien_trailer}" target="_blank" style="background-color: #00DD00">TRAILER</a></li>
                        <li style="list-style: none;" style="background-color: #00DD00"><a href="${film.lien_vo}" target="_blank" style="background-color: #00DD00">FULL ANGLAIS</a></li>
                        <li style="list-style: none;" style="background-color: #00DD00"><a href="${film.lien_vf}" target="_blank" style="background-color: #00DD00">FULL FRANCAIS</a></li>
                    </ul>
                </div>
            </li>
        `;
